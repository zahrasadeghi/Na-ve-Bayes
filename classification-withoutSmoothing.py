...
def calculateP(text, pclass1, pclass2, countallword1, countallword2, countDistWords1,countDistWords2,class1words,class2words):
    ...
    if pWordInClass1 == 0 and pWordInClass2 == 0:
        pass
    else:
        print(1)
    if pWordInClass1 > pWordInClass2:
        ...
        return 1
    elif pWordInClass1 < pWordInClass2:
...
def classifier():
    ...
    test1, train1 = randonPartitioner(class1, 0.6)
    test2, train2 = randonPartitioner(class2, 0.6)
    ...
    for sentence in sentence2:
        ...
        if c == 1:
            ...
            tn += 1
    print(tn, tp, fp, fn)
    print(impWOrd85.keys())

    precision = tp/(tp+fp)
    recall = tp/(tp+fn)

    print(precision, recall)
    print(impWOrd77.keys())
    print(impWOrd85.keys())
